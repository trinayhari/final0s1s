...
@Autonomous(name="EncoderTest2", group="Pushbot")
        ...
        if (opModeIsActive()) {
           ...
           robot.leftDrive.setZeroPowerBehavior(DcMotor.ZeroPowerBehavior.BRAKE);
            ...
            while (opModeIsActive() &&
                    ...
                    (robot.leftDrive.isBusy() && robot.rightDrive.isBusy()) && robot.rightBackDrive.isBusy() && robot.leftBackDrive.isBusy()) {

                // Display it for the driver.
                telemetry.addData("Path1",  "Running to %7d :%7d", newLeftTarget,  newRightTarget, newRightBackTarget, newLeftBackTarget);
                telemetry.addData("Path2",  "Running at %7d :%7d",
                        robot.leftDrive.getCurrentPosition(),
                        robot.rightDrive.getCurrentPosition(), robot.rightBackDrive.getCurrentPosition(), robot.leftBackDrive.getCurrentPosition());
                telemetry.update();
            }
            robot.leftDrive.setZeroPowerBehavior(DcMotor.ZeroPowerBehavior.BRAKE);
            robot.leftBackDrive.setZeroPowerBehavior(DcMotor.ZeroPowerBehavior.BRAKE);
